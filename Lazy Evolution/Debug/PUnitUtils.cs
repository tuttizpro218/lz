...
namespace LazyEvo.Debug
{
    internal class PUnitUtils : PUnit
    {
        ...
        public List<NameValuePair> GetNameValuePairs()
        {
            ...
            nvList.Add(new NameValuePair("HolyPower", flag ? "" + HolyPower : ""));
            nvList.Add(new NameValuePair("HolyPower Max", flag ? "" + MaximumHolyPower : ""));

            nvList.Add(new NameValuePair("DemonicFury", flag ? "" + DemonicFury : ""));
            nvList.Add(new NameValuePair("DemonicFury Max", flag ? "" + MaximumDemonicFury : ""));
            nvList.Add(new NameValuePair("BurningEmbers", flag ? "" + BurningEmbers : ""));
            nvList.Add(new NameValuePair("BurningEmbers Max", flag ? "" + MaximumBurningEmbers : ""));
            nvList.Add(new NameValuePair("ShadowOrbs", flag ? "" + ShadowOrbs : ""));
            nvList.Add(new NameValuePair("ShadowOrbs Max", flag ? "" + MaximumShadowOrbs : ""));
            nvList.Add(new NameValuePair("Alternate", flag ? "" + Alternate : ""));
            nvList.Add(new NameValuePair("Alternate Max", flag ? "" + MaximumAlternate : ""));
            nvList.Add(new NameValuePair("DarkForce", flag ? "" + DarkForce : ""));
            nvList.Add(new NameValuePair("DarkForce Max", flag ? "" + MaximumDarkForce : ""));
            nvList.Add(new NameValuePair("LightForce", flag ? "" + LightForce : ""));
            nvList.Add(new NameValuePair("LightForce Max", flag ? "" + MaximumLightForce : ""));
            nvList.Add(new NameValuePair("Runes", flag ? "" + Runes : ""));
            nvList.Add(new NameValuePair("Runes Max", flag ? "" + MaximumRunes : ""));
            nvList.Add(new NameValuePair("ComboPoints", flag ? "" + ComboPoints : ""));
            nvList.Add(new NameValuePair("ComboPoints Max", flag ? "" + MaximumComboPoints : ""));

            nvList.Add(new NameValuePair("SoulShard", flag ? "" + SoulShard : ""));
            nvList.Add(new NameValuePair("SoulShard Max", flag ? "" + MaximumSoulShard : ""));
