...
{
    internal class ArcaneChargesCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public ArcaneChargesCondition()
        {
        ...
        {
            get { return "Arcane Charges"; }
        }

        public override string XmlName
        {
            get { return "ArcaneChargesCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.ArcaneCharges == Value;
        ...
        private void CreateText(List<Node> re)
        {
            ...
            labelX.Text = "This condition will allow you to check the number of ArcaneCharges .";
            labelX.Visible = true;
