...
{
    internal class HolyPowerCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public HolyPowerCondition()
        {
        ...
        {
            get { return "Holy Power"; }
        }

        public override string XmlName
        {
            get { return "HolyPowerCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.HolyPower == Value;
        ...
        private void CreateText(List<Node> re)
        {
            ...
            labelX.Text = "This condition will allow you to check the number of Holy Power.";
            labelX.Visible = true;
