...
{
    internal class DarkForceCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public DarkForceCondition()
        {
        ...
        {
            get { return "Dark Force"; }
        }

        public override string XmlName
        {
            get { return "DarkForceCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.DarkForce == Value;
        ...
        private void CreateText(List<Node> re)
        {
            ...
            labelX.Text = "This condition will allow you to check the number of Dark Force.";
            labelX.Visible = true;
