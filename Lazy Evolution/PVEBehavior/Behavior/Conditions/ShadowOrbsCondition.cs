...
{
    internal class ShadowOrbsCondition : AbstractCondition
    {
        private IntegerInput valueInput;

        public ShadowOrbsCondition()
        {
        ...
        {
            get { return "Shadow Orbs"; }
        }

        public override string XmlName
        {
            get { return "ShadowOrbsCondition"; }
        }
        ...
        public override bool IsOk
        {
            get
            {
                if (Condition.Equals(ConditionEnum.EqualTo))
                    return ObjectManager.MyPlayer.ShadowOrbs == Value;
        ...
        private void CreateText(List<Node> re)
        {
            ...
            labelX.Text = "This condition will allow you to check the number of Shadow Orbs.";
            labelX.Visible = true;
